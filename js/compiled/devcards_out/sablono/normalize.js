...
if(((cljs.core.set_QMARK_.call(null,class$__$1)) || (cljs.core.sequential_QMARK_.call(null,class$__$1))) && (cljs.core.every_QMARK_.call(null,(function (p1__23172_SHARP_){
return ((p1__23172_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__23172_SHARP_ === 'string');
}),class$__$1))){
...
var G__23174 = attrs;
var G__23174__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(attrs))?cljs.core.update_in.call(null,G__23174,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$):G__23174);
return G__23174__$1;
});
/**
...
var len__17863__auto___23178 = arguments.length;
var i__17864__auto___23179 = (0);
while(true){
if((i__17864__auto___23179 < len__17863__auto___23178)){
args__17870__auto__.push((arguments[i__17864__auto___23179]));

var G__23180 = (i__17864__auto___23179 + (1));
i__17864__auto___23179 = G__23180;
continue;
} else {
}
break;
...
return cljs.core.into.call(null,cljs.core.PersistentHashSet.EMPTY,p1__23175_SHARP_);
});})(maps__$1))
...
var G__23177 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
var G__23177__$1 = ((!(cljs.core.empty_QMARK_.call(null,classes__$1)))?cljs.core.assoc.call(null,G__23177,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1):G__23177);
return G__23177__$1;
});

sablono.normalize.merge_with_class.cljs$lang$maxFixedArity = (0);

sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq23176){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq23176));
});
/**
...
var vec__23184 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__23184,(0),null);
var names = cljs.core.nth.call(null,vec__23184,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__23184,tag_name,names){
return (function (p1__23181_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__23181_SHARP_));
});})(matches,vec__23184,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__23184,tag_name,names){
return (function (p1__23182_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__23182_SHARP_));
});})(matches,vec__23184,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__23185){
var vec__23188 = p__23185;
var tag = cljs.core.nth.call(null,vec__23188,(0),null);
var content = cljs.core.nthnext.call(null,vec__23188,(1));
...
var vec__23189 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__23189,(0),null);
var id = cljs.core.nth.call(null,vec__23189,(1),null);
var class$ = cljs.core.nth.call(null,vec__23189,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1457370614009