...
var len__17863__auto___23163 = arguments.length;
var i__17864__auto___23164 = (0);
while(true){
if((i__17864__auto___23164 < len__17863__auto___23163)){
args__17870__auto__.push((arguments[i__17864__auto___23164]));

var G__23165 = (i__17864__auto___23164 + (1));
i__17864__auto___23164 = G__23165;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq23162){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq23162));
});
/**
...
var vec__23167 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__23167,(0),null);
var words = cljs.core.nthnext.call(null,vec__23167,(1));
...
var G__23169 = clojure.set.rename_keys.call(null,m,kmap);
var G__23169__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__23169,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys):G__23169);
return G__23169__$1;
} else {
return m;
}
...
//# sourceMappingURL=util.js.map?rel=1457370613917