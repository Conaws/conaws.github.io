...
var depth = cljs.core.get.call(null,map__23902__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.call(null,map__23902__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__23905 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__23905__$1 = (((G__23905 == null))?null:cljs.core.persistent_BANG_.call(null,G__23905));
var G__23905__$2 = (((G__23905__$1 == null))?null:cljs.core.get.call(null,G__23905__$1,key));
return G__23905__$2;
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__23906){
var vec__23909 = p__23906;
var frame = cljs.core.nth.call(null,vec__23909,(0),null);
var frames = cljs.core.nthnext.call(null,vec__23909,(1));
...
var or__16805__auto__ = datascript.pull_api.pull_seen_eid.call(null,frame__$1,frames,eid);
...
var results = (function (){var G__23910 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
var G__23910__$1 = ((cljs.core.seq.call(null,kvps))?cljs.core.conj_BANG_.call(null,G__23910,kvps):G__23910);
return G__23910__$1;
})();
...
var map__23913 = parent;
var map__23913__$1 = ((((!((map__23913 == null)))?((((map__23913.cljs$lang$protocol_mask$partition0$ & (64))) || (map__23913.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__23913):map__23913);
var recursion = cljs.core.get.call(null,map__23913__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.call(null,map__23913__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_23915 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
datascript.pull_api.expand_frame = ((function (pattern_23915){
...
return cljs.core.assoc.call(null,datascript.pull_api.subpattern_frame.call(null,pattern_23915,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});})(pattern_23915))
;
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__23917){
var vec__23923 = p__23917;
var parent = cljs.core.nth.call(null,vec__23923,(0),null);
var frames = cljs.core.nthnext.call(null,vec__23923,(1));
...
var found = cljs.core.not_empty.call(null,(function (){var G__23924 = datoms;
var G__23924__$1 = (cljs.core.truth_(limit)?cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.take.call(null,limit),G__23924):G__23924);
return G__23924__$1;
})());
...
var datom_val = (cljs.core.truth_(forward_QMARK_)?((function (ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__23923,parent,frames){
return (function (d){
return d.v;
});})(ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__23923,parent,frames))
:((function (ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__23923,parent,frames){
return (function (d){
return d.e;
});})(ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__23923,parent,frames))
);
...
if(cljs.core.truth_((function (){var and__16793__auto__ = component_QMARK_;
...
var as_value = (function (){var G__23925 = datom_val;
var G__23925__$1 = ((ref_QMARK_)?cljs.core.comp.call(null,((function (G__23925,ref_QMARK_,component_QMARK_,multi_QMARK_,datom_val,limit,found,vec__23923,parent,frames){
return (function (p1__23916_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__23916_SHARP_]);
});})(G__23925,ref_QMARK_,component_QMARK_,multi_QMARK_,datom_val,limit,found,vec__23923,parent,frames))
,G__23925):G__23925);
return G__23925__$1;
})();
var single_QMARK_ = !(multi_QMARK_);
return cljs.core.conj.call(null,frames,cljs.core.update.call(null,parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key,(function (){var G__23926 = cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,as_value),found);
var G__23926__$1 = ((single_QMARK_)?cljs.core.first.call(null,G__23926):G__23926);
return G__23926__$1;
})()));
...
return cljs.core.conj.call(null,frames,(function (){var G__23927 = parent;
var G__23927__$1 = ((cljs.core.contains_QMARK_.call(null,opts,new cljs.core.Keyword(null,"default","default",-1987822328)))?cljs.core.update.call(null,G__23927,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts)):G__23927);
return G__23927__$1;
})());
}
});
...
var vec__23929 = spec;
var attr_key = cljs.core.nth.call(null,vec__23929,(0),null);
var opts = cljs.core.nth.call(null,vec__23929,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.call(null,(function (p__23930){
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__23932){
var vec__23934 = p__23932;
var frame = cljs.core.nth.call(null,vec__23934,(0),null);
var frames = cljs.core.nthnext.call(null,vec__23934,(1));
return datascript.pull_api.expand_result.call(null,frames,datascript.pull_api.into_BANG_.call(null,new cljs.core.Keyword(null,"expand-kvps","expand-kvps",44141154).cljs$core$IFn$_invoke$arity$1(frame),(function (){var or__16805__auto__ = datascript.pull_api.single_frame_result.call(null,new cljs.core.Keyword("datascript.pull-api","expand-rev","datascript.pull-api/expand-rev",2143627459),frame);
if(cljs.core.truth_(or__16805__auto__)){
return or__16805__auto__;
} else {
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__23935){
var vec__23938 = p__23935;
var frame = cljs.core.nth.call(null,vec__23938,(0),null);
var frames = cljs.core.nthnext.call(null,vec__23938,(1));
...
var vec__23939 = cljs.core.first.call(null,datoms_by_attr);
var attr = cljs.core.nth.call(null,vec__23939,(0),null);
var datoms = cljs.core.nth.call(null,vec__23939,(1),null);
...
var attr = cljs.core.get.call(null,map__23943__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.call(null,map__23943__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__23945 = recursion;
var G__23945__$1 = ((cljs.core.some_QMARK_.call(null,attr))?datascript.pull_api.push_recursion.call(null,G__23945,attr,eid):G__23945);
return G__23945__$1;
})();
...
var eid = cljs.core.get.call(null,map__23948__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.call(null,map__23948__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
var or__16805__auto__ = datascript.pull_api.pull_seen_eid.call(null,frame,frames,eid);
if(cljs.core.truth_(or__16805__auto__)){
return or__16805__auto__;
} else {
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__23950){
while(true){
var vec__23952 = p__23950;
var frame = cljs.core.nth.call(null,vec__23952,(0),null);
var frames = cljs.core.nthnext.call(null,vec__23952,(1));
var temp__4423__auto__ = cljs.core.seq.call(null,new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__4423__auto__){
var eids = temp__4423__auto__;
...
var G__23953 = db;
var G__23954 = cljs.core.conj.call(null,frames,datascript.pull_api.reset_frame.call(null,frame,cljs.core.rest.call(null,eids),cljs.core.not_empty.call(null,cljs.core.persistent_BANG_.call(null,new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__23953;
p__23950 = G__23954;
continue;
}
...
while(true){
var G__23959 = (((new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first.call(null,frames)) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first.call(null,frames)).fqn:null);
switch (G__23959) {
case "expand":
var G__23964 = db;
var G__23965 = datascript.pull_api.pull_expand_frame.call(null,db,frames);
db = G__23964;
frames = G__23965;
continue;
...
case "expand-rev":
var G__23966 = db;
var G__23967 = datascript.pull_api.pull_expand_reverse_frame.call(null,db,frames);
db = G__23966;
frames = G__23967;
continue;
...
case "pattern":
var G__23968 = db;
var G__23969 = datascript.pull_api.pull_pattern_frame.call(null,db,frames);
db = G__23968;
frames = G__23969;
continue;
...
case "recursion":
var G__23970 = db;
var G__23971 = datascript.pull_api.pull_recursion_frame.call(null,db,frames);
db = G__23970;
frames = G__23971;
continue;
...
break;
case "done":
var vec__23960 = frames;
var f = cljs.core.nth.call(null,vec__23960,(0),null);
var remaining = cljs.core.nthnext.call(null,vec__23960,(1));
var result = (function (){var G__23961 = cljs.core.persistent_BANG_.call(null,new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
var G__23961__$1 = ((cljs.core.not.call(null,new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f)))?cljs.core.first.call(null,G__23961):G__23961);
return G__23961__$1;
})();
if(cljs.core.seq.call(null,remaining)){
var G__23972 = db;
var G__23973 = cljs.core.conj.call(null,cljs.core.rest.call(null,remaining),(function (){var G__23962 = cljs.core.first.call(null,remaining);
var G__23962__$1 = (cljs.core.truth_(result)?cljs.core.update.call(null,G__23962,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result):G__23962);
return G__23962__$1;
})());
db = G__23972;
frames = G__23973;
...
var eids__$1 = cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,(function (p1__23974_SHARP_){
return datascript.db.entid_strict.call(null,db,p1__23974_SHARP_);
})),eids);
...
//# sourceMappingURL=pull_api.js.map?rel=1457371271659